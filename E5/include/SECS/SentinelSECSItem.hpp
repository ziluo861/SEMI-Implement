...
class SentinelSECSItem final : public SECSItemBase {
  FormatCode TryGetFormat() override { return FormatCode::None; }
  bool TryParseContent(std::string_view) override { return false; }
  ...
  bool TrySerialize(std::vector<std::uint8_t> &) override { return false; }
