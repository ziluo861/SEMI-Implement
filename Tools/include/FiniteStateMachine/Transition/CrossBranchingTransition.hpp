...
public:
    explicit CrossBranchingTransition(State<TIndex>& departure, State<TIndex>& destination, 
        State<TIndex>& branching, RequirementMonitor *requirementmonitor, 
        CallbackType transitioncallback, 
        bool enter_history) : BaseType(departure, destination, requirementmonitor, 
